...
public class TambahMahasiswaActivity extends AppCompatActivity {
    ...
    private EditText _nimEditText, _alamatEditText, _namaEditText, _tahunMasukEdtiText, _tanggalLahirEditText, _tempatLahirEditText;
    ...
    private void initSaveButton()
    {
        ...
        _saveButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                String tahunMasuk = _tahunMasukEdtiText.getText().toString();
    ...
    private void initInputs()
    {
        ...
        _tahunMasukEdtiText = findViewById(R.id.tahunMasukEditText);
